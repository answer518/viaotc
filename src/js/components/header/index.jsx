			...
			<div className="header">
				<div className="header-content">
					...
					<div className="operate-block">
						...
						{/*<div 
							className="operate-block-item language"
							ref={this.getLanguageRef}
						>
							<div 
								className={languageHead}
								onClick={this.handlelanguageShow}
							>
								<span className="substr inline" style={{marginRight: '30px', width: '55px', textAlign: 'left'}}>{activeItem.name}</span>
								<div className="arrow"></div>
							</div>	
							{languageShow && <div className="custom-select-body language-body">
